...
class DropTheNumber extends Game with TapDetector {
  ...
  void render(Canvas canvas) {
    if(!gameOver) {
        ...
        drawText(canvas, getTimeformat(displayDuration), Colors.black, 30, 252, 220);
  ...
  void drawRect(Canvas canvas, double x, double y, double width, double height, Color color) {
  ...
  void drawRectStroke(Canvas canvas, double x, double y, double width, double height, Color color, double strokeWidth) {
    Rect rect = Rect.fromLTWH(
        getX(x),
        getY(y),
        getX(width),
