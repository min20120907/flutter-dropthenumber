...
class DrawHandler {
    ...
    **********************************************************************/
    void initVideos() {
        for(int i=0; i<15; i++) {
            loadUiImage("assets/video/power1/" + i.toString() + ".png").then((value) => verticalSuperPowerVideo.add(value));
        }
        for(int i=0; i<19; i++) {
            loadUiImage("assets/video/power2/" + i.toString() + ".png").then((value) => horizontalSuperPowerVideo.add(value));
        }
    }
    ...
    **********************************************************************/
    void drawGameOverScreen(int score, int highestScore, Duration elapsedTime) {
        ...
        drawText("Highest Score: "+highestScore.toString(), 50, 45, Colors.black, 30);
    ...
    **********************************************************************/
    String getTimeformat(Duration totalSecond) {
        return sprintf("%02d:%02d", [totalSecond.inSeconds ~/ 60, (totalSecond.inSeconds % 60).toInt()]);
    }
    ...
    **********************************************************************/
    void drawBlock(Block block) {
        ...
        // Draw block text
        drawText(block.v.toString(), block.x+width/2, block.y+height/2-2, Colors.black, 22);
    }
